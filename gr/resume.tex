...
\note{2012}\textsc{Συμμετοχή σε διαγωνισμό τεχνολογικής καινοτομίας
(start-up competition)}\\
\emph{\href{https://www.createchallenge.org/previous-editions}{1st
International Create Challenge 2012}, Martigny, Switzerland, 2012}\\
...
\emph{Πρόγραμμα εκπαίδευσης για την δια βίου μάθηση} ΚΕΔΙΒΙΜ ΕΑΠ\\[.2cm]
\note{2021--2022}\textsc{Κατασκευή Συστημάτων Διάδρασης}\\
\emph{Ανοιχτό βιβλίο για την 3βάθμια εκπαίδευση} ΚΑΛΛΙΠΟΣ+ ΕΜΠ\\[.2cm]
\note{2020--2021}\textsc{Σχεδίαση Συνεργατικού Εκπαιδευτικού
Βιντεοπαιχνιδιού Ρόλων}\\
\emph{Επιστημονικά Υπεύθυνος} ΕΔΒΜ Υπουργείο Ανάπτυξης\\[.2cm]
...
\note{2020--}\textsc{Οπτικοποίηση της Πληροφορίας, Πανεπιστήμιο
Πατρών}\\
\emph{Εργασίες}\\[.2cm]
\note{2009--2013, 2019--}\textsc{Κοινωνικά και Συνεργατικά Συστήματα
(Συνεργατικές Εφαρμογές), ΙΠ}\\
\emph{Εργασίες}\\[.2cm]
\note{2019--2020}\textsc{Διάχυτος Υπολογισμός, Πανεπιστήμιο Πατρών}\\
\emph{Εργασίες, 50\%}\\[.2cm]
\note{2019--2020}\textsc{Συνεργατικές Τεχνολογίες, Πανεπιστήμιο
Πατρών}\\
\emph{Εργασίες, 50\%}\\[.2cm]
