...
συμμετοχικού περιεχομένου για \href{http://mibook.org}{βιβλίο για την
3βάθμια εκπαίδευση}.} Αυτοχρηματοδότηση\\[.2cm]
\note{2012--}\textsc{Ανοιχτό λογισμικό στην έρευνα}\\
...
\note{2018--2019}\textsc{DEFEND (Data Governance for Supporting GDPR)}\\
\emph{Συλλογή απαιτήσεων από τους χρήστες} Ευρωπαϊκή Επιτροπή
(Horizon2020)\\[.2cm]
...
\note{2016--}\textsc{Διογένης Αλεξανδράκης}\\
...
\noindent
\note{2019}\textsc{Γιάννης Πριόβολος, ΕΑΠ}\\
\emph{Επαυξημένο επιτραπέζιο παιχνίδι}\\[.2cm]
...
\emph{Οπτικοποίηση δεδομένων}\\[.2cm]
...
\noindent
\note{2011--}\textsc{Απανταχού υπολογίζειν (Εξυπνα Περιβάλλοντα και
Εφαρμογές), ΙΠ}\\
\emph{Εργασίες}\\[.2cm]
\note{2009--}\textsc{Πολυμέσα, ΙΠ}\\
...
\href{http://uitv.epidro.me}{\underline{http://uitv.epidro.me}} Το
σύστημα επιτρέπει την εύκολη ενημέρωση της πήλης με περιεχόμενο σχετικά
με την έρευνα στην ψηφιακή τηλεόραση. Αποθετήριο ανοικτού κώδικα για το
εκπαιδευτικό και ερευνητικο λογισμικό στο τμήμα:
\href{https://github.com/ioniodi}{\underline{https://github.com/ioniodi}}
...
Αιγαίου (\href{http://my.aegean.gr/}{\underline{http://my.aegean.gr}}).
...
τμήματος, οδηγού σπουδών, github courseware, εξ αποστάσεως διδασκαλία
και αξιολόγηση.
